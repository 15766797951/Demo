...
<div class="right">
       ...
       <form method="post" action="billlist">
			...
			<span>商品名称：</span>
			<input name="params['productName']" type="text" value="">
			<span>供应商：</span>
			<select name="params['providerId']">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${helper.results }" varStatus="status">
				<tr>
					<td>
...
<script type="text/javascript" src="../js/billlists.js"></script>
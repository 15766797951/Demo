...
<div class="right">
        ...
        <div class="search">
        	<form method="post" action="providerlist">
				<input name="method" value="query" type="hidden">
				<span>供应商编码：</span>
				<input name="params['proCode']" type="text" value="">
				
				<span>供应商名称：</span>
				<input name="params['proContact']" type="text" value="">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${helper.results }" varStatus="status">
				<tr>
					<td>
